...
const MyPurchasePage      = lazy(() => import('./pages/MyPurchasePage'));
        ...
        <>
            ...
            <Suspense fallback={<PageLoader />}>
                <Routes>
                    ...
                    <Route path="/offers" element={<ProtectedRoute><MyOffersPage /></ProtectedRoute>} />
                    ...
                    <Route path="/sale-contract/:id"   element={<ProtectedRoute><SaleContractPage /></ProtectedRoute>} />
                    <Route path="/mon-achat/:offerId"  element={<ProtectedRoute><MyPurchasePage /></ProtectedRoute>} />
