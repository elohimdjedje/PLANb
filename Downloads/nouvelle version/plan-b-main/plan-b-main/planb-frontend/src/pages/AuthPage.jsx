...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowLeft, Star } from 'lucide-react';
...
function AuthPage() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
            {/* Fond style Gamma avec dégradés complexes et motifs */}
            <div className="absolute inset-0 bg-gradient-to-br from-orange-50 via-white to-orange-100"></div>
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(251,146,60,0.15),transparent_50%)]"></div>
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_rgba(249,115,22,0.1),transparent_50%)]"></div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-md p-8 relative z-10 border border-orange-100/50">
                ...
                <div className="text-center mb-6">
                    <img src="/logofinal.png" alt="PlanB" className="h-40 mx-auto mb-4" style={{ width: 'auto', objectFit: 'contain' }} />
                    ...
                    {nextPage === '/upgrade' && (
                        <div className="mt-3 inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl text-sm font-medium">
                            <Star className="w-4 h-4 text-orange-500 fill-orange-500" /> Vous serez redirigé vers le plan Pro après inscription
                        </div>
                    )}
                </div>
