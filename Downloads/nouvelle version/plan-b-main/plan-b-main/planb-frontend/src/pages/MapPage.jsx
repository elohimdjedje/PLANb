...
import { MapPin, Search, Navigation, X, Home, Building2, Car, ChevronLeft, ChevronRight, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 pt-16 flex relative">
            ...
            <div className="md:hidden fixed top-16 left-0 right-0 z-[999] p-3 bg-white border-b border-gray-200 shadow-sm">
                <div className="flex gap-2">
                    ...
                    >
                        <Navigation className="w-4 h-4" />
                        {geoLoading ? '...' : nearActive ? `${nearRadius}km` : 'Près'}
                    </button>
                </div>
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-[999] bg-white rounded-t-2xl shadow-2xl max-h-[40vh] overflow-hidden">
                ...
                <div className="overflow-y-auto max-h-[calc(40vh-48px)]">
                    {isLoading ? (
                        <div className="flex items-center justify-center h-32">
                            ...
                            {filtered.map(listing => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className="flex-shrink-0 w-48 bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow"
                                    >
                                        <img
                                            src={getImageUrl(listing.mainImage || listing.images?.[0]?.url) || '/placeholder.jpg'}
                                            alt={listing.title}
